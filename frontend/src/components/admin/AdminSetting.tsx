...
const AdminSetting = () => {
  ...
  const [systemEmail, setSystemEmail] = useState("admin@csg.com");
  const [systemName, setSystemName] = useState("Community Saving Groups");
  ...
  const handleReset = () => {
    ...
    setSystemEmail("admin@csg.com");
    setSystemName("Community Saving Groups");
